            ...
            <dialog ref={dialogRef} className="modal">
                <div className="modal-box max-w-xl max-h-150 p-5">
                    ...
                    <div className="flex w-full flex-col">
                        ...
                        <h5 className="text-lg">This is where you can find all information regarding this
                            application.</h5>
                        ...
                        <ul className="list bg-base-100 rounded-box shadow-md">
                            ...
                            <li className="list-row">
                                ...
                                <div>
                                    ...
                                    <div className="text-xs uppercase font-semibold opacity-60">Transcribes your text
                                    </div>
                                </div>
                            ...
                            <li className="list-row">
                                ...
                                <div>
                                    <div>Translation</div>
                                    <div className="text-xs uppercase font-semibold opacity-60">Allows for you to
                                        communicate
                                    </div>
                                </div>
                                <p className="list-col-wrap text-xs">
                            ...
                            <li className="list-row">
                                ...
                                <div>
                                    <div>Email</div>
                                    <div className="text-xs uppercase font-semibold opacity-60">Transcripts sent to
                                        you
                                    </div>
                                </div>
                                <p className="list-col-wrap text-xs">
